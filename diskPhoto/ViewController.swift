...
final class ViewController: UIViewController {
    ...
    private func setupViews() {
        ...
        textField.text = "https://avatars.mds.yandex.net/get-pdb/985144/b02f6408-87ff-4ef9-bfec-186aee52afa5/s800"
    ...
    @objc private func uploadFile() {
        ...
        //get special name from new picture
        let fullNameArr = fileUrl.components(separatedBy: "/")
        print(fullNameArr[fullNameArr.count - 3])
        ...
        components?.queryItems = [
            ...
            URLQueryItem(name: "path", value: fullNameArr[fullNameArr.count - 3]),
        ]
        guard let url = components?.url else { return }
        var request = URLRequest(url: url)
